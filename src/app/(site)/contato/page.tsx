          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white p-8 rounded-lg border border-slate-200 shadow-sm space-y-6">
              ...
              <ul className="space-y-5 text-sm">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-slate-600 text-xs mt-0.5 leading-relaxed hover:text-brand hover:underline block"
                    >
                      {settings.endereco}
                    </a>
                  </div>
                ...
                <li className="flex items-start gap-3">
                  <div className="p-2.5 bg-brand/10 text-brand rounded-md shrink-0">
              ...
              <div className="pt-4 border-t border-slate-200">
                ...
                <div className="flex items-center gap-3">
                  <a href={settings.redesSociais.instagram} target="_blank" rel="noreferrer" className="p-2 bg-slate-100 hover:bg-brand hover:text-white text-slate-700 rounded-full transition-colors" title="Instagram">
                  ...
                  <a href={settings.redesSociais.facebook} target="_blank" rel="noreferrer" className="p-2 bg-slate-100 hover:bg-brand hover:text-white text-slate-700 rounded-full transition-colors" title="Facebook">
                  ...
                  <a href={settings.redesSociais.youtube} target="_blank" rel="noreferrer" className="p-2 bg-slate-100 hover:bg-brand hover:text-white text-slate-700 rounded-full transition-colors" title="YouTube">
